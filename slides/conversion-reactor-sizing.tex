...
\begin{frame}\frametitle{Profiles along the reactor: $X$}
	\begin{center}
		\includegraphics[width=0.80\textwidth]{\imagedir/reactors/example-2-2/X-profile.png}
	\end{center}
\end{frame}

\begin{frame}\frametitle{Profiles along the reactor: $r_A$}
	\begin{center}
		\includegraphics[width=0.90\textwidth]{\imagedir/reactors/example-2-2/rA-profile.png}
	\end{center}
\end{frame}
