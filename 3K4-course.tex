...
\subtitle[]{\large ChE 3K4\\\vspace{0.5cm}\includegraphics[width=0.2\textwidth]{\imagedir/teaching/logos/3K4-logo-2013.png}\vspace{-1.5cm} }
\author[]{}
\institute[]{}
...
\href{http://learnche.mcmaster.ca/3K4}{http://learnche.mcmaster.ca/3K4}\\} \vspace{0.5cm}{\footnotesize Overall revision number: \hgversion (\monthname~\THEYEAR)} %\twodigit{\THEDAY}-\twodigit{\THEMONTH}-
}
