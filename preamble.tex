...
\settoggle{internal}{true}      % set "true" when the PDF is for internal use; use "false" when publishing it publically, on-line
...
% KGD: removed footer completely: Presentation Zen: no redundant information
